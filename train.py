...
def get_model(n_qubits, n_layers, data_reupload):
    ...
    # dev = qml.device("forest.qvm", device="4q", wires=n_qubits, noisy=True)
    shapes = {
...
def main():
    names = [('struc_1_0',), ('struc_1_1',), ('struc_1_2',), ('struc_1_3',), ('struc_1_4',)]
    with Pool() as pool:
        pool.starmap(train, names)
    # train('a0')
